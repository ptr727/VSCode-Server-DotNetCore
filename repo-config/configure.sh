...
cmd_check() {
  ...
  # access to docker.io/vkhurana/vscode-server-codex-dotnetcore. Verify it by hand in the Docker Hub account.
  note "verify manually: Docker Hub access token valid with push to docker.io/vkhurana/vscode-server-codex-dotnetcore"
