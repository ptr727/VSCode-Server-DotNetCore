...
```sh
REPO=vkhurana/VSCode-Server-Codex-DotNetCore ./repo-config/configure.sh apply   # sync live rulesets + settings + security
REPO=vkhurana/VSCode-Server-Codex-DotNetCore ./repo-config/configure.sh check   # confirm no drift
```
